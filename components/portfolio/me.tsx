...
export default function Me() {
  return (
    <div className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-sky-600 py-6 sm:py-12 text-white font-ligh text-lg">
      <div className="relative border-white bg-sky-600 px-6 pt-10 pb-8 shadow-xl  drop-shadow-2xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-2xl sm:rounded-3xl sm:border-2 sm:px-12">
